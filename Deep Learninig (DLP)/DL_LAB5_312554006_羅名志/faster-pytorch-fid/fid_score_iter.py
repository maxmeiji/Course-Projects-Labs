...
from faster_pytorch_fid.inception import InceptionV3
from faster_pytorch_fid.torch_sqrtm import sqrtm, torch_matmul_to_array, np_to_gpu_tensor
...
def fid_score():
    ...
    fid_value = calculate_fid_given_paths("./test_results","./faster_pytorch_fid/test_gt.csv",
                                          50,
                                          device,
                                          2048,
                                          num_workers)
    print(f"inf: {fid_value}")
    return fid_value
