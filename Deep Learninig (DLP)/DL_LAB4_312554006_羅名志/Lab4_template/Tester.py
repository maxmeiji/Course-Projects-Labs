...
class Test_model(VAE_Model):
    ...
    def val_one_step(self, img, label, idx=0):
        ...
        H_pred = []
        H_pred.append(self.frame_transformation(img[0]))
        ...
        for i in range(1,self.val_vi_len):
            ...
            z, _, _ = self.Gaussian_Predictor(H_pred[0], H_label[i])
        ...
        self.make_gif(label_frame[0], os.path.join(self.args.save_root, f'label_seq{idx}.gif'))
...
# python ./Lab4_template/Trainer.py --DR ./LAB4_Dataset  --save_root ./output --ckpt_path ./save/epoch=6.ckpt